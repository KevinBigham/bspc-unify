...
| Coach `demo/device-build` | PR 12 merged green as `3b5269f`; strict-types local mission `d534efe` | Node 22 full quality; client Jest 1,212/129; Functions 191/16; portal build + knip green |
